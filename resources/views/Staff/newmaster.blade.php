    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="nav-item  @if(Request::is('Staff/Profile/*')) active @endif">
                    <a class="nav-link" href="{{route('profile')}}">
                        <i class="nc-icon nc-circle-09"></i>
                        <p>Profile</p>
                    </a>
                </li>
                <li class="nav-item  @if(Request::is('Staff/Timesheet/*')) active @endif">
                    <a class="nav-link" href="{{route('timesheet')}}">
                        <i class="nc-icon nc-single-copy-04"></i>
                        <p>Timesheet</p>
                    </a>
                </li>
                <li class="nav-item  @if(Request::is('Staff/Paysheet/*')) active @endif">
                    <a class="nav-link" href="{{route('paysheet')}}">
                        <i class="nc-icon nc-notes"></i>
                        <p>Paysheet</p>
                    </a>
                </li>
                <li class="nav-item  @if(Request::is('Staff/Request/*')) active @endif">
