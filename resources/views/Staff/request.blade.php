                            ...
                            <table  id="mytable" align="center" class="table table-hover">
                                ...
                                @foreach($requests as $request)
                                    <tr>
                                        ...
                                        <td>{{$request->note}}</td>
                                        <td>
                                            <button class="view-request" style="border-radius: 50px;background-color: #00b9fffa;">
                                                <a href="{{route('viewRequest', ['id' => $request->request_id])}}" style="color: white !important;">Approved</a>
                                            </button>
